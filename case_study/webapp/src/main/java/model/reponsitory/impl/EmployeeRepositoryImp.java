...
public class EmployeeRepositoryImp implements EmployeeRepository {
    ...
    public List<Employee> getList() {
        ...
        if (connection != null) {
            try {
                statement = connection.prepareStatement("select employee_id ,employee_name, employee_birthday, employee_id_card, employee_salary,\n" +
    ...
    public boolean createEmployee(Employee employee) {
        ...
        if (connection != null) {
            try {
                statement = connection.prepareStatement("insert into employee( employee_name, employee_birthday, employee_id_card, employee_salary,\n" +
